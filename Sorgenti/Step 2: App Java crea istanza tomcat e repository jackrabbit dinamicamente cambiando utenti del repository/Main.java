...
public class Main {
   ...
   static void CreateInstanceSubFolders() throws IOException, InterruptedException
   {
        ...
        System.out.println("\r\nriempie la cartella /conf con tutti i file che si trovano in /etc/tomcat7:\r\n" + "sudo cp -a /etc/" + TOMCAT_VERSION + "/. " + TOMCAT_PATH + "/" + instance_name + "/conf/");
       ...
       //cancella il file server.xml copiato prima in /conf
        System.out.println("\r\ncancella il file server.xml copiato prima in /conf:\r\n" + "sudo rm " + TOMCAT_PATH + "/" + instance_name + "/conf/server.xml");
...
"./startup.sh");        
        ...
        Process p = Runtime.getRuntime().exec("sudo chmod u+x " + TOMCAT_SCRIPTS + "/start_" + instance_name + ".sh");
        p.waitFor();           
...
"./shutdown.sh\n"
        ...
        Process p = Runtime.getRuntime().exec("sudo chmod u+x " + TOMCAT_SCRIPTS + "/stop_" + instance_name + ".sh");
        p.waitFor();        
   ...
   static void CreateScriptRestart() throws IOException, InterruptedException
   {
       //stop_<instance_name>.sh
        ...
        Process p = Runtime.getRuntime().exec("sudo chmod u+x " + TOMCAT_SCRIPTS + "/restart_" + instance_name + ".sh");
        p.waitFor();            
   }        
   ...
   */
   ...
   static void Start_Instance() throws IOException, InterruptedException
   {
       ...
       Process p = Runtime.getRuntime().exec("sudo sh " + TOMCAT_SCRIPTS + "/start_" + instance_name + ".sh");
        p.waitFor();       
   }
   ...
   static void Stop_Instance() throws IOException, InterruptedException
   {
       ...
       Process p = Runtime.getRuntime().exec("sudo sh " + TOMCAT_SCRIPTS + "/stop_" + instance_name + ".sh");
        p.waitFor();       
   }   
