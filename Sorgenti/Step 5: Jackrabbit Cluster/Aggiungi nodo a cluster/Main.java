...
public class Main {
     ...
     public static void main(String[] args) throws Exception 
    {
        ...
        Start_Instance(jr_node_tomcat_scripts_path);        
        
        Stop_Instance(jr_node_tomcat_scripts_path);
   ...
   static void FindJR_NodeName() throws SQLException
   {
       ...
       String query = "SELECT ID FROM " + cluster_pm_name + ".NODE ORDER BY ID DESC;";
        Connection cn = DriverManager.getConnection("jdbc:mysql://" + MYSQL_URL + "/" + MYSQL_JRSAAS_CONFIG_DB + "?user=" + db_user + "&password=" + db_password + "");
...
"./shutdown.sh\n"
   ...
   */
   ...
   static void Start_Instance(String script_path) throws IOException, InterruptedException
   {
       String cmd = "sudo sh " + script_path + "/start_" + jr_node_name + ".sh";
   ...
   static void Stop_Instance(String script_path) throws IOException, InterruptedException
   {
       String cmd = "sudo sh " + script_path + "/stop_" + jr_node_name + ".sh";
   ...
   {              
        ...
        Stop_Instance(last_jr_node_tomcat_script_path);
        ...
        Start_Instance(last_jr_node_tomcat_script_path);
...
"  <param name=\"url\" value=\"jdbc:mysql://" + MYSQL_URL + "/" + cluster_pm_name + "\"/>\n" +
...
"    <param name=\"url\" value=\"jdbc:mysql://" + MYSQL_URL + "/" + cluster_pm_name + "\"/> <!-- use your database setup -->\n" +
